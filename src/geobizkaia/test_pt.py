...
model = YOLO(
    r"C:\Users\gonzalo.echeverria\BILBOMATICA\TASK\Segmentation-1\model\best_yolov8m-seg.pt"
)
...
image_name = "arizgoiti_1000_2024_geo.tif"
image_file = f"data\\{image_name}"

images_test_folder_path = "images_test"
